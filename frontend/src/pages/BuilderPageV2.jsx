...
export default function BuilderPageV2() {
  ...
  return (
    <DashboardLayout>
      {/* builder-root: CSS controls height on mobile (calc(100vh - 56px)) */}
      <div className="builder-root">
        ...
        {/* Mobile toggle */}
        <div className="d-md-none" style={{ background: '#1E293B', borderBottom: '1px solid #334155', display: 'flex', padding: '8px 16px', gap: 8, flexShrink: 0 }}>
          {['edit', 'preview'].map((v) => (
        ...
        <div className="builder-split">
          ...
          {/* Form panel */}
          <div className={'builder-form-panel ' + (mobileView === 'preview' ? 'd-none d-md-flex' : 'd-flex')}>
          ...
          {/* Preview panel */}
          <div className={'builder-preview-panel ' + (mobileView === 'edit' ? 'd-none d-md-flex' : 'd-flex')}>
